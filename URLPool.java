...
public class URLPool {
    ...
    private LinkedList<URLDepthPair> UnprocessedURLs; //обработанные URL-адреса
    ...
    public URLPool(int max) {
        ...
        UnprocessedURLs = new LinkedList<URLDepthPair>();
    ...
    public synchronized void printURLs() {
        System.out.println("\nUnique URLs Found: " + UnprocessedURLs.size());
        while (!UnprocessedURLs.isEmpty()) {
            System.out.println(UnprocessedURLs.removeFirst());
        }
    }
}